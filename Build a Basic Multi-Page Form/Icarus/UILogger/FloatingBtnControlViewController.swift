...
//        view.addSubview(button)
    ...
    private func snapButtonToSocket() {
        ...
        case 1:
            ...
            self.resetBtn.frame = CGRect(x: self.textView.frame.maxX, y: self.textView.frame.minY, width: -20, height: 20)
            self.newView.frame = CGRect(x:self.view.frame.minX, y: self.view.frame.maxY, width: (textView.frame.width+button.frame.width+resetBtn.frame.width), height: -(textView.frame.height+button.frame.height))
        case 2:
            self.textView.frame = CGRect(x: bestSocket.x-buttonSize.width/2, y: bestSocket.y + buttonSize.height/2, width: -250, height: 200)
        ...
        case 3:
            self.textView.frame = CGRect(x: bestSocket.x-buttonSize.width/2, y: bestSocket.y - buttonSize.height/2, width: -250, height: -200)
            self.resetBtn.frame = CGRect(x: self.textView.frame.maxX, y: self.textView.frame.minY, width: -20, height: 20)
            self.newView.frame = CGRect(x:self.view.frame.maxX, y: self.view.frame.maxY, width: -(textView.frame.width+button.frame.width+resetBtn.frame.width), height: -(textView.frame.height+button.frame.height))
        case 4:
            self.textView.frame = CGRect(x: bestSocket.x-1.5*buttonSize.width, y: bestSocket.y + buttonSize.height/2, width: 300, height: 200)
            self.resetBtn.frame = CGRect(x: self.textView.frame.maxX, y: self.textView.frame.minY, width: -20, height: 20)
            self.newView.frame = CGRect(x:self.view.frame.midX-self.newView.frame.width/2, y: self.view.frame.midY-self.newView.frame.height/2, width: (textView.frame.width+button.frame.width+resetBtn.frame.width), height: (textView.frame.height+button.frame.height))
